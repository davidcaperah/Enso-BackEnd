...
try {
    ...
    $mail->Username   = 'alerta@enso-learning.com.co';                     //SMTP username
    $mail->Password   = '$ensoalerta$';                               //SMTP password
    $mail->SMTPSecure = 'ssl';            //Enable implicit TLS encryption
    $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

    //Recipients
    $mail->setFrom('Alerta@enso-learning.com.co', 'Soporte Enso-Learning');
